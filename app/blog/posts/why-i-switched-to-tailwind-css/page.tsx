...
export default function Blog1() {
    ...
    return <PostLayout title={"Why I Switched to Tailwind CSS from Bootstrap"} content={BlogContents} />;

    function BlogContents() {
        return (
            <div className="space-y-8">
                <p className="text-lg text-[var(--color4)] leading-relaxed">
                    ...
                    <a href="https://tailwindcss.com/" target="_blank" className="text-blue-500 hover:text-blue-700 underline">
                        Tailwind CSS
                    </a>
                    —and here’s why.
                </p>

                <h2 className="text-3xl font-semibold text-[var(--color4)] mt-6">Advantages of Tailwind CSS</h2>

                <h3 className="text-2xl font-semibold text-[var(--color4)] mt-4">1. Utility-First Approach</h3>
                <p className="text-lg text-[var(--color4)] leading-relaxed">
                ...
                <h3 className="text-2xl font-semibold text-[var(--color4)] mt-6">2. Customization and Design Freedom</h3>
                <p className="text-lg text-[var(--color4)] leading-relaxed">
                ...
                <h3 className="text-2xl font-semibold text-[var(--color4)] mt-6">3. Responsive Design Made Simple</h3>
                <p className="text-lg text-[var(--color4)] leading-relaxed">
